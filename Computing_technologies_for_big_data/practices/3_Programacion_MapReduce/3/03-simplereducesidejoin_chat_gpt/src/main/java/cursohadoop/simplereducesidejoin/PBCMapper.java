...
public class PBCMapper extends Mapper<LongWritable, Text, IntWritable, TaggedText> {
	...
	public void map(LongWritable key, Text value, Context context) throws IOException,
		...
		try {
			...
			// TODO: Completa 
			countryTagged.set("country", countryYear);
			
			// Escribimos la patente y el país etiquetado
			// TODO: Completa
			context.write(new IntWritable(patente),countryTagged);
...
public class PBCMapper extends Mapper<LongWritable, Text, IntWritable, TaggedText> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        try {
            ...
            // Tomamos el número de patente (campo 0) como IntWritable
            ...
            // Etiquetamos el país y el año y lo guardamos en countryTagged
