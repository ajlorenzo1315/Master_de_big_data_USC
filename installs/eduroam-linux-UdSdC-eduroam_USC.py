...
Config.instname = "Universidade de Santiago de Compostela"
Config.profilename = "eduroam (USC)"
Config.url = "https://www.usc.gal/cau"
Config.email = "cau@usc.gal"
Config.title = "eduroam CAT"
Config.server_match = "radius.usc.es"
...
Config.user_realm = "usc.es"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.usc.es']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@usc.es"
Config.tou = ""
