...
ruta_archivo <-  "./1_Descriptive_analysis_of_data_set/estadistica_empleos.csv"
...
valores_unicos <- unique(datos$Situacion.profesional)
valores_unicos
valores_unicos <- unique(datos$Agregados.de.empleo)
valores_unicos
