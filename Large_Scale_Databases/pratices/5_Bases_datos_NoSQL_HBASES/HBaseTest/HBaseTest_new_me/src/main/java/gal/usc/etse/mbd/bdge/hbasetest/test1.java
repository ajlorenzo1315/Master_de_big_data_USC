...
public class test1 {
    public static void main(String[] args) {
        ...
        //Ejercicio_2
        String comentario2 = "//Ejercicio_2;";
        ...
        //Ejercicio_3
        String comentario3 = "//Ejercicio_3";
        ...
        //Ejercicio_4
        String comentario4 = "//Ejercicio_4";
    ...
    private static void PSQLejercio5(String nombre){
        DAOPeliculas daopsql = new DAOPeliculasPgsql("localhost", "5432", "bdge", "alumnogreibd", "greibd2021");
        List<Pelicula> pels  = daopsql.getPeliculasDirigidas(nombre);
        
        // Imprimimos los datos de esta pelicula
        ImprimirPeliculas.imprimeDirector(pels);
    ...
    private static void HbaseEjercio5(String nombre){
       DAOPeliculas daohbase = new DAOPeliculasHBase();
       List<Pelicula> pels = daohbase.getPeliculasDirigidas(nombre);
       ImprimirPeliculas.imprimeDirector(pels);
       daohbase.close();
   }
}
